...
- Affected Files:
  - `harnes/00_README.md`
  - `harnes/02_RUN_MODES.md`
  - `harnes/templates/05_ONE_LINE_PROMPTS.md`
  - `harnes/templates/10_SESSION_BOOT_TEMPLATE.md`
  - `harnes/templates/50_SPRINT_REVIEW_TEMPLATE.md`
  - `harnes/templates/70_NEXT_PROMPT_TEMPLATE.md`
  - `harnes/templates/20_PROJECT_MANAGER_PERSONA_TEMPLATE.md`（削除）
  - `harnes/03_LEARNING_SYSTEM.md`
- Migration Notes:
