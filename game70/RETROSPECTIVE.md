...
## 8) Iteration Update（2026-04-24 / new構成）
- 追加実施:
  - `game70/new/` を新設し、`game70/old/` を参照元にした別ファイル群で開発継続
  - iPhone向けに疑似フルスクリーン（CSSクラス切替）を実装
  - 線の表現を拡張（単色 / 単色グラデーション / 線幅ゆらぎ）
  - カメラ回転に慣性を導入し、タッチドラッグをヌルヌル化
- 判定: **Adopt**
